...
This Code of Conduct applies within all project spaces — including the repository, issues, pull requests, discussions, and any other channels — and also applies when an individual is officially representing the project in public spaces.

## Reporting

Report Code of Conduct incidents to the maintainers through one of these channels:

- **GitHub:** Open a private report via the repository's [Security Advisories](https://github.com/AgentBigBrain/AgentBigBrain/security/advisories) (for sensitive matters)
- **Issue:** Open a GitHub issue with the `[conduct]` label for non-sensitive concerns
