...
3. `docs/agent-instructions/architecture-boundaries.md`
4. `docs/agent-instructions/deterministic-safety-rules.md`
5. `docs/agent-instructions/user-experience-and-capability-principles.md`
6. `docs/agent-instructions/operational-gates.md`
7. `docs/agent-instructions/documentation-rules.md`
8. `docs/agent-instructions/testing-rules.md`
9. `docs/agent-instructions/integrity-rules.md`
10. `docs/agent-instructions/definition-of-done.md`
