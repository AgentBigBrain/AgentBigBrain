...
6. `docs/agent-instructions/regex-and-intent-boundaries.md`
7. `docs/agent-instructions/semantic-routing-and-lexical-policy.md`
8. `docs/agent-instructions/intent-engine-contracts.md`
9. `docs/agent-instructions/deterministic-speech.md`
10. `docs/agent-instructions/user-experience-and-capability-principles.md`
11. `docs/agent-instructions/operational-gates.md`
12. `docs/agent-instructions/documentation-rules.md`
13. `docs/agent-instructions/versioning-rules.md`
14. `docs/agent-instructions/commit-rules.md`
15. `docs/agent-instructions/testing-rules.md`
16. `docs/agent-instructions/integrity-rules.md`
17. `docs/agent-instructions/definition-of-done.md`
