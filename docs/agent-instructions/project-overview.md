...
- The repository is AI-first for maintainability: folder READMEs, explicit plan docs, and thin
  stable entrypoints should make the correct edit surface discoverable without guesswork.
