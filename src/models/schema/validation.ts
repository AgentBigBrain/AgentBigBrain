 ...
 *
 * **What it talks to:**
 * - Uses `toPlannerRecord` from `../../core/plannerActionSchema`.
 *
 ...
 *
 * **What it talks to:**
 * - Uses `isPlannerActionType` from `../../core/plannerActionSchema`.
 *
 ...
 *
 * @param schemaName - Active schema name.
...
/**
 * Normalizes structured model output into a stable shape for the schema subsystem.
 *
 * @param schemaName - Active schema name.
 * @param payload - Candidate payload.
 * @returns Canonical output payload for downstream model clients.
 */
