...
function buildIdentityInterpretationPrompt(
  ...
  return [
    ...
    "Examples:",
    '- "My name is Morgan." => {"kind":"self_identity_declaration","candidateValue":"Morgan","confidence":"high","shouldPersist":true}',
    '- "I already told you my name is Morgan several times." => {"kind":"self_identity_declaration","candidateValue":"Morgan","confidence":"medium","shouldPersist":true}',
