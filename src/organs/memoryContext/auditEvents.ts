...
export async function appendMemoryAccessAudit(
  ...
  try {
    await auditStore.appendEvent({
      ...
      ingestOperationCount: options?.ingestOperationCount,
      retrievalOperationCount: options?.retrievalOperationCount,
      synthesisOperationCount: options?.synthesisOperationCount,
      renderOperationCount: options?.renderOperationCount,
      promptMemoryOwnerCount: options?.promptMemoryOwnerCount,
      promptMemorySurfaceCount: options?.promptMemorySurfaceCount,
      mixedMemoryOwnerDecisionCount: options?.mixedMemoryOwnerDecisionCount,
      aliasSafetyDecisionCount: options?.aliasSafetyDecisionCount,
