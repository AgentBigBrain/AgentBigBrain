...
import type { SourceRecallProjectionEntry } from "../sourceRecall/sourceRecallProjection";
...
export interface ProjectionSnapshot {
  ...
  sourceRecallProjectionEntries?: readonly SourceRecallProjectionEntry[];
