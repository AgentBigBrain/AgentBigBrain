/**
 * @fileoverview Deterministic Stage 6.85 mission-UX helpers for state transitions, approval-default policy, and stable user-facing envelopes.
 */

import {
  ApprovalGranularityV1,
 ...
 *
 * **Why it exists:**
 * Defines public behavior from `stage6_85MissionUxPolicy.ts` for other modules/tests.
 *
 * **What it talks to:**
...
/**
 * Normalizes refs into a stable shape for `stage6_85MissionUxPolicy` logic.
 *
 * **Why it exists:**
 ...
 *
 * **Why it exists:**
 * Keeps construction of mission ux result envelope consistent across call sites.
 *
 * **What it talks to:**
